...
let frames = 0
let ramdomIntervale = Math.floor((Math.random() * 500) + 500)
let game = {
    over: false,
    active: true
}
...
function animate(){
                        ...
                        setTimeout(() => {
                            ...
                            if(invaderFound && projectileFound){
                                ...
                                if(grid.invaders.length > 0){
                                    ...
                                    const lasttInvader = grid.invaders[grid.
                                        invaders.length - 1]
                                    grid.width = 
                                        lasttInvader.position.x -
    ...
    //spawing enemies
    if(frames % ramdomIntervale === 0){
        grids.push(new Grid())
        ramdomIntervale = Math.floor((Math.random() * 500) + 500)
        frames = 0
    }
